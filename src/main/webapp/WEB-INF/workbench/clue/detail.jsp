...
<body>
						...
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    ...
						    <%--<span class="glyphicon glyphicon-search form-control-feedback"></span>--%>
							  <button type="button" onclick="queryUnbindActivity(1,10)" class="btn btn-primary" >查询</button>
						  </div>
						</form>
					</div>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
				<h3 id="contactInfo">	<small id="companyInfo" > </small></h3>
		</div>
	...
	<div style="position: relative; top: -70px;">
		<div style="position: relative; left: 40px; height: 30px;">
			...
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b id="fullname"></b></div>
		...
		<div id="remarkDiv" style="background-color: #E6E6E6; width: 870px; height: 90px;">
			<form role="form" style="position: relative;top: 10px; left: 10px;">
				...
				<p id="cancelAndSaveBtn" style="position: relative;left: 737px; top: 10px; display: none;">
					...
					<button type="button" onclick="addClueRemark()" class="btn btn-primary">保存</button>
				</p>
			</form>
		</div>
	</div>
...
<script>
	...
	//============显示交易详情页
	$.post("/crm/workbench/clue/toDetail",{
		'id':'${id}'
	},function (data) {
		//拼详情页
		$("#head_fullname").text(data.fullname);
		$("#head_conpany").text(data.company);
		...
		$("#contactInfo").text(data.fullname);
	...
	function addRemark(clueRemark) {
		$("#remarkDiv").before("\t<div class=\"remarkDiv\" id="+clueRemark.id+"remarkDiv  style=\"height: 60px;\">\n" +
				...
				"\t\t\t<div id="+clueRemark.id+" style=\"position: relative; top: -40px; left: 40px;\" >\n" +
				...
				"\t\t\t\t\t<a class=\"myHref\" href=\"javascript:void(0);\"><span class=\"glyphicon glyphicon-edit\" style=\"font-size: 20px; color: #E6E6E6;\"></span></a>\n" +
				"\t\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;\n" +
				"\t\t\t\t\t<a onclick=\"deleteClueRemark('"+clueRemark.id+"')\" class=\"myHref\" href=\"javascript:void(0);\"><span class=\"glyphicon glyphicon-remove\" style=\"font-size: 20px; color: #E6E6E6;\"></span></a>\n" +
				"\t\t\t\t</div>\n" +
				"\t\t\t</div>\n" +
				"\t\t</div>");
	...
	function queryActivity() {
		$.get("/crm/workbench/clue/queryActivity",{
			'id':'${id}'
		},function(data){
			//拼接活动页面
			var activities = data;
	...
	function addClueRemark() {
		$.get("/crm/workbench/clue/addClueRemark",{
			'clueId':'${id}',
	...
	function deleteClueRemark(id) {
		//确定删除吗
		layer.msg('确定删除该条线索备注吗', {
			time: 0 //不自动关闭
			,btn: ['确定', '取消']
			,yes: function(index){
				layer.close(index);
				$.post("/crm/workbench/clue/deleteRemark",{
					'id':id
				},function (data) {
					if (data.ok){
						layer.alert(data.mess, {icon: 6});
	...
	//点击关联时候市场活动  查询未绑定的市场活动   并且支持模糊查询
	//传参需要考虑怎么传线索id
	function queryUnbindActivity(page,pageSize) {
		$.get("/crm/workbench/clue/queryUnbindActivity",{
			'page':page,
			'pageSize':pageSize,
			...
			for (var i = 0;i <activities.length;i++){
				...
				$("#activityPage").bs_pagination({
					...
					onChangePage : function(event, obj){
						...
						queryUnbindActivity(obj.currentPage,obj.rowsPerPage);
						//把全选按钮取消掉
						$("#father").prop("checked",false);
					}
				});
			}
			$("#unbindBody").html(context);
		},'json')
	}

	//  点击关联按钮  关联市场活动备注  支持多个关联   类似批量删除
	function bind() {
		var ids = [];
